...
namespace BrowserAutomation
{
    ...
    public class GoogleSearchEngineTest : TestInitialize
    {
        ...
        public GoogleSearchEngineTest() : base("GoogleInput")
        {
        ...
        public void T001GoogleSearchEngineTest()
        {
            ...
            test = extent.CreateTest("T001GoogleSearchEngineTest").Info("This test performs the input and Output operation on Google Search Engine with Browser of our Choice (which is passed in the form of JSON");
            ...
            homePage.EnterTextInGoogleSearchBox(testData.SearchText);
            ...
            string searchResultText = driver.FindElement(By.XPath("//div[@id='search']//div//h3[1]")).Text;
